...
FOUR LAYERS, all failing the build except the last.
  ...
  Apex tests                   128   every deploy
  Accessibility (live pages)   516   against the deployed site
...
Two Agentforce agents, both Active:
  Curb_Cut       v8  public, 6 subagents, 7 Apex actions
...
─────────────────────────────────────────────────────────────────────
  ...
  sf apex run test -o curbcut -l RunLocalTests      128 tests
  python3 tests/a11y_audit.py                      516 checks, live pages
