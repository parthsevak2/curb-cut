...
Run time **4:59**. Picture is locked, and these timings are generated from the
...
choice, not a shortcut: a film about access should not assume you can hear it.
If you do record a voice over it, keep it low and unhurried. The pictures are
making the argument already, and a narrator pushing the feeling will undo it.

Every line below fits its hold at 140 words per minute with two seconds of air.
Where a card already carries its sentence, the direction is silence: reading a
slide aloud to somebody who is reading it is how a film loses them.

| In | Out | | Line |
|---|---|---|---|
| 0:00 | 0:27 | screen | This is Curb Cut. It's for the one in four of us who has something at work that's quietly hard, and who never asked, because asking meant explaining our bodies to a manager. Here, you just say what's getting in the way. You never have to say why. |
| 0:26 | 0:43 | screen | One in four isn't a number on a slide. It's your sister. The colleague who never asks. The person beside you on the bus. We don't get to look past them. |
| 0:42 | 0:56 | screen | The request is written in her words. And this line is in every single one: I'm not sharing a diagnosis, and I'm not required to. |
| 0:56 | 1:05 | card | That's the whole form. This is the one most people get instead. |
| 1:04 | 1:20 | card | You've done this yourself. Think of the last time something at work was quietly hard. You worked out what it would cost to ask, and you said nothing. |
| 1:20 | 1:29 | screen | One in four of us has a disability. Three in a hundred tell their employer. |
| 1:28 | 1:34 | card | _silence_ |
| 1:33 | 1:42 | card | Nothing is sent until she clearly says yes. If she hedges, it waits. |
| 1:42 | 1:55 | screen | Here it is, live, in the agent. She hedges, and it waits. She says yes, and only then does it move. |
| 1:54 | 2:01 | screen | Sent, with a date she can hold them to. |
| 2:01 | 2:15 | card | And it's there wherever she is: on the web, by voice, by text, by email, in Slack, or through any assistant she already uses. |
| 2:14 | 2:38 | screen | The same thing by text, on a basic phone with no internet. She texts CURB CUT, says what's hard, and real options come back with what they usually cost. She picks one. It writes the request in her words, and waits for her yes. |
| 2:37 | 2:47 | screen | Or she rings the same number and just says it. It never rings her back. |
| 2:47 | 2:56 | screen | By email, the answer comes from the same door, so it's the same answer. |
| 2:55 | 3:03 | screen | In Slack, it's a private message. It can't post anywhere else. |
| 3:03 | 3:16 | screen | And any assistant she already uses can ask on her behalf, through a tool that can find and draft, but can never send. |
| 3:15 | 3:21 | card | _silence_ |
| 3:20 | 3:38 | screen | There's no field for a diagnosis anywhere in this system. It isn't locked away. It simply isn't there, so it can never be leaked, or shown to a manager, or asked for later. |
| 3:38 | 3:53 | screen | So when her manager asks the system what's wrong with her, it says no. Not because of a permission setting, but because there's nothing there to find. |
...
**Direction.** Slow. This is the one that has to land.
...
> One in four of us has a disability. Three in a hundred tell their employer.
...
**Direction.** Unhurried. Let them read the phones.

### 2:37  voice.png

> Or she rings the same number and just says it. It never rings her back.

15 words, 10s hold.

### 2:47  email.png

> By email, the answer comes from the same door, so it's the same answer.

14 words, 9s hold.

### 2:55  slack.png

> In Slack, it's a private message. It can't post anywhere else.
