...
{ const s=light(); chip(s,'04  THE HONEST PART');
  ...
  T(s,{t:'124 Apex   |   494 invariants   |   333 accessibility   |   131 Sa11y   |   28 contrast   |   16 reading level   |   all passing, every build',
...
{ const s=light(); chip(s,'APPENDIX  |  VERIFICATION');
  ...
  const cmd=[['494','structural invariants','python3 tests/invariants.py'],
